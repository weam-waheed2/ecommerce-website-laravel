        ...
        <div class="container" style="max-width: 1610px;">
            <div class="home-slide-cover">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1 shadow-sm" style="border-radius: 30px;overflow:hidden">
                    <div class="single-hero-slider rectangle single-animation-wrap" style="background: linear-gradient(to bottom, rgb(0 0 0 / 37%) 0%, rgb(0 0 0 / 40%) 100%), url({{asset('assets/imgs/slider/10.jpg')}});background-size: cover;background-position: center;">
                    ...
                    <div class="single-hero-slider rectangle single-animation-wrap" style="background: linear-gradient(to bottom, rgb(0 0 0 / 37%) 0%, rgb(0 0 0 / 0%) 100%), url({{asset('assets/imgs/slider/9.jpg')}});background-size: cover;background-position: center;">
        
                    </div>
                    <div class="single-hero-slider rectangle single-animation-wrap" style="background: linear-gradient(to bottom, rgb(0 0 0 / 37%) 0%, rgb(0 0 0 / 0%) 100%), url({{asset('assets/imgs/slider/slider-7.jpeg')}});background-size: cover;background-position: center;">
            ...
            <div class="col-md-6 my-2">
                <div class="cards">
                    ...
                    <article>
                        ...
                        <div class="pic"><img src="{{asset('assets/imgs/brand/safana-new-logo.png')}}" alt="Safana Logo"></div>
                    </article>
                    <div class="actions">
                        <a class="btn btn-xs w-100" href="{{ \App\Models\Post::find(7)->url() }}">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                
                    </div>
                    </div>
                </div>
                {{-- <div class="card wow animate__ animate__fadeInUp animated" data-wow-delay="0" style="background-color: #edfff7;">
                    <div class="card-body banner-text mb-3">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <a class="btn btn-xs" href="{{ \App\Models\Post::find(7)->url() }}">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                            </div>
                            <div class="col-lg-3 d-none d-lg-block">
                                <img src="{{asset('assets/imgs/brand/safana-new-logo.png')}}" alt="Safana Logo" width="100%">
                            </div>
                        </div>
                    </div>
                </div> --}}
            ...
            <div class="col-md-6 my-2">
                <div class="cards">
                    ...
                    <article>
                        ...
                        <div class="title">Brand in Siam Ocean</div>
                        <div class="pic"><img src="{{asset('assets/imgs/brand/fiorella-logo.png')}}" alt="Fiorella Logo"></div>
                    </article>
                    <div class="actions">
                        <a class="btn btn-xs w-100" href="{{ \App\Models\Post::find(8)->url() }}">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                
                    </div>
                    </div>
                </div>
                {{-- <div class="card wow animate__ animate__fadeInUp animated" data-wow-delay=".2s" style="background-color: #edfff7;">
                    <div class="card-body banner-text mb-3">
                        <div class="row">
                            <div class="col-lg-9">
                                <h4 class="my-3">
                                ...
                                <a class="btn btn-xs" href="{{ \App\Models\Post::find(8)->url() }}">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                            </div>
                            <div class="col-lg-3 d-none d-lg-block">
                                <img src="{{asset('assets/imgs/brand/fiorella-logo.png')}}" alt="Fiorella Logo" width="100%">
                            </div>
                        </div>
                    </div>
                </div> --}}
...
<img src="{{ asset('assets/imgs/cta-3.png') }}" alt="" />
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                <div class="row product-grid-4">
                    {{--@php
						$products = \App\Models\Post::where('post_type', 'product')
					...
					@foreach($products as $product)
						@php
							$metaData = json_decode($product->meta('data'), true);
						@endphp
						@if(!empty($metaData) && !empty($metaData['weight']))
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 m-auto image-contact">
				<img src="{{asset('assets/imgs/theme/contact.png')}}" alt="Contact us">
			</div>
		</div>
	</div>
</section>
