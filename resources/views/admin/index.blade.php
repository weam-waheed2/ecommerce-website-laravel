                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-3">
                        <div class="text-center mb-n5">
                            <img src="{{asset('dashboard/images/backgrounds/welcome-bg.svg')}}" alt="" class="img-fluid mb-n4">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{asset('dashboard/images/svgs/icon-user-male.svg')}}" width="50" height="50" class="mb-3" alt="">
                            <p class="fw-semibold fs-3 text-info mb-1">Users</p>
                            <h5 class="fw-semibold text-info mb-0">{{App\Models\User::count()}}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="item">
                <div class="card border-0 zoom-in bg-success-subtle shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{asset('dashboard/images/svgs/icon-briefcase.svg')}}" width="50" height="50" class="mb-3" alt="">
                            <p class="fw-semibold fs-3 text-info mb-1">Products</p>
                            <h5 class="fw-semibold text-info mb-0">{{App\Models\Post::where('post_type','product')->count()}}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="item">
                <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{asset('dashboard/images/svgs/icon-favorites.svg')}}" width="50" height="50" class="mb-3" alt="">
                            <p class="fw-semibold fs-3 text-info mb-1">Pages</p>
                            <h5 class="fw-semibold text-info mb-0">{{App\Models\Post::where('post_type','page')->count()}}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="item">
                <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{asset('dashboard/images/svgs/icon-connect.svg')}}" width="50" height="50" class="mb-3" alt="">
                            <p class="fw-semibold fs-3 text-info mb-1">Articles</p>
                            <h5 class="fw-semibold text-info mb-0">{{App\Models\Post::where('post_type','post')->count()}}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="item">
                <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img src="{{asset('dashboard/images/svgs/icon-speech-bubble.svg')}}" width="50" height="50" class="mb-3" alt="">
                            <p class="fw-semibold fs-3 text-info mb-1">Contact Us</p>
                            <h5 class="fw-semibold text-info mb-0">{{App\Models\Request::count()}}</h5>
                        </div>
                    </div>
                </div>
            </div>
