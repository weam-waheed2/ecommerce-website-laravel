...
<head>
    ...
    <title>
        @yield('title','Siam Ocean - Dashboard')
    </title>
    <!-- Owl Carousel  -->
            ...
            <div><!-- ---------------------------------- -->
                ...
                <div class="brand-logo d-flex align-items-center justify-content-between pt-2">
                    <a href="{{url('/')}}" class="text-nowrap logo-img">
                        <img src="{{ asset('assets/imgs/theme/siam-logo.png')}}" class="dark-logo" alt="Logo-Dark" style="width: 60%;margin: auto;">
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar pt-4" data-simplebar>
                    ...
                    @if(config('sidebar'))
                        @foreach(config('sidebar') as $sidebar)
                            @if(isset($sidebar['items']) && !empty($sidebar['items']))
                                <li class="sidebar-item">
                                    <a class="sidebar-link has-arrow {{ request()->is($sidebar['url']) ? 'active' : '' }}" href="javascript:void(0)" aria-expanded="false">
                                        <span class="d-flex">
                                            {!! $sidebar['icon'] !!}
                                        </span>
                                    ...
                                    <ul aria-expanded="false" class="collapse first-level">
                                        @foreach($sidebar['items'] as $child)
                                        <li class="sidebar-item">
                                            <a href="{{ url($child['url']) }}" class="sidebar-link {{ request()->is($child['url']) ? 'active' : '' }}">
                                        ...
                                        @endforeach
                                        @if(isset($sidebar['terms']))
                                            @foreach($sidebar['terms'] as $sub)
                                                <li class="sidebar-item">
                                                    <a href="{{ url('admin/terms/' . $sub['taxonomy']) }}" class="sidebar-link {{ request()->is($sub['taxonomy']) ? 'active' : '' }}">
                                                        <div class="round-16 d-flex align-items-center justify-content-center">
                                                            <i class="ti ti-circle"></i>
                                                        </div>
                            ...
                            @else
                                <li class="sidebar-item">
                                    <a class="sidebar-link {{ request()->is($sidebar['url']) ? 'active' : '' }}" href="{{ url($sidebar['url']) }}" aria-expanded="false">
                                        <span>
                                            {!! $sidebar['icon'] !!}
                                        </span>
                                        <span class="hide-menu">{{ $sidebar['name'] }}</span>
                ...
                <div class="fixed-profile p-3 mx-3 mb-2 bg-secondary-subtle rounded mt-3">
                    <div class="hstack gap-3">
                        <div class="john-img">
                            <img src="{{ asset('dashboard/images/profile/user-1.jpg')}}" class="rounded-circle" width="40"
                                height="40" alt>
                        </div>
                                ...
                                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link nav-icon-hover" href="javascript:void(0)"
                                            ...
                                            <img src="{{ asset('dashboard/images/svgs/icon-flag-en.svg')}}" alt width="20px"
                                            ...
                                            <div class="message-body">
                                                <a href="javascript:void(0)"
                                                    ...
                                                    <div class="position-relative">
                                                        <img src="{{ asset('dashboard/images/svgs/icon-flag-en.svg')}}" alt
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('dashboard/images/svgs/icon-flag-fr.svg')}}" alt
                                                            width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20">
                                                    </div>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('dashboard/images/svgs/icon-flag-sa.svg')}}" alt
                                                            width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20">
                                                    </div>
                    ...
                    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                        ...
                        <nav class="sidebar-nav scroll-sidebar">
                            <div class="offcanvas-header justify-content-between">
                                <img src="{{ asset('dashboard/images/logos/favicon.ico')}}" alt class="img-fluid">
                    ...
                    <nav class="navbar navbar-expand-xl container-fluid p-0">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item d-none d-xl-block">
                                <a href="index.html" class="text-nowrap nav-link">
                                    <img src="{{ asset('assets/imgs/theme/siam-logo.png')}}" class="dark-logo"
                                        width="180" alt>
                                    <img src="{{ asset('assets/imgs/theme/siam-logo.png')}}" class="light-logo"
                                        width="180" alt>
                                </a>
                            </li>
                        ...
                        <div class="d-block d-xl-none">
                            <a href="{{url('/')}}" class="text-nowrap nav-link">
                                <img src="{{ asset('assets/imgs/theme/siam-logo.png')}}" width="180" alt>
                            </a>
                        </div>
                        <a class="navbar-toggler nav-icon-hover p-0 border-0" href="javascript:void(0)"
                            data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav"
