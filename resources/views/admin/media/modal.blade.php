                    ...
                    <div class="col-lg-3 bg-gray-100 d-flex align-items-start flex-column bd-highlight mb-3">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <select class="form-select" gx_media_library="search-dimensions" data-control="select2" data-dropdown-parent="#gx_media_library">
                                ...
                                @foreach(App\Models\Media::distinct('dimensions')->select('dimensions')->get() as $dimension)
                                    <option value="{{ $dimension->dimensions }}">{{ $dimension->dimensions }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!--end::Input group-->
                        ...
                        <form class="text-center w-100" method="POST" gx_media_library="form" action="{{ url('admin/media/update') }}">
                            @csrf
