                ...
                <div class="col-xl-3 primary-sidebar sticky-sidebar mt-30">
                    <div class="sidebar-widget widget-vendor mb-30 bg-grey-9 box-shadow-none">
                        ...
                        <ul class="contact-infor">
                            <li><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-location.svg')); ?>" alt="" /><strong>Address: </strong> <br> <span>Al metawaren area Sadat City, Monufia Governorate, Egypt</span></li>
                            <li><img src="<?php echo e(asset('assets/imgs/theme/icons/icon-contact.svg')); ?>" alt="" /><strong>Contact:</strong> <br> <span><?php echo e(\App\Models\Option::get('phone')); ?></span></li>
                        </ul>
                        <ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siam_ocean_app\resources\views/single-product.blade.php ENDPATH**/ ?>