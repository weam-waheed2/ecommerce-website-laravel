                    ...
                    <div class="row justify-content-center w-100">
                        <div class="col-lg-4">
                            <div class="text-center">
                                <img src="<?php echo e(asset('dashboard/images/backgrounds/errorimg.svg')); ?>" alt="" class="img-fluid" width="500">
                                <h1 class="fw-semibold mb-7 fs-9">Opps!!!</h1>
                                <h4 class="fw-semibold mb-7">This page you are looking for could not be found</h4>
                                <a class="btn btn-primary" href="<?php echo e(url('/')); ?>" role="button">Back to Home</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\user\Desktop\projects\products-site\app\resources\views/error.blade.php ENDPATH**/ ?>