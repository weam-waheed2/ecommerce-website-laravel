...
<style>.cards {
 ...
 .cards .card:before {
	 ...
	 content: "";
	 position: absolute;
	 background-image: linear-gradient(to top, #ecffec 0%, #006230 100%);
        ...
        <div class="container" style="max-width: 1610px;">
            <div class="home-slide-cover">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1 shadow-sm" style="border-radius: 30px;overflow:hidden">
                    <div class="single-hero-slider rectangle single-animation-wrap" style="background: linear-gradient(to bottom, rgb(0 0 0 / 37%) 0%, rgb(0 0 0 / 0%) 100%), url(<?php echo e(asset('assets/imgs/slider/slider-1_LE_auto_x2.jpg')); ?>);background-size: cover;background-position: center;">
                    ...
                    <div class="single-hero-slider rectangle single-animation-wrap" style="background: linear-gradient(to bottom, rgb(0 0 0 / 37%) 0%, rgb(0 0 0 / 0%) 100%), url(<?php echo e(asset('assets/imgs/slider/slider-2_LE_auto_x2.jpg')); ?>);background-size: cover;background-position: center;">
                    </div>
...
<section class="product-tabs section-padding position-relative">
    <div class="container">
        <div class="section-title style-2 wow animate__animated animate__fadeIn">
            <h3>Our Popular <span style="color: #00984d;">Products</span></h3>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                <div class="row product-grid-4">
                    <?php $__currentLoopData = \App\Models\Post::where('post_type', 'product')->where('post_status', 'publish')->limit(9)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siam_ocean_app\resources\views/index.blade.php ENDPATH**/ ?>