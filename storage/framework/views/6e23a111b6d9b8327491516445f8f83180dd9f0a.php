...
<div class="page-content pt-50">
    ...
    <section class="container mb-50 d-none d-md-block">
        <div class="border-radius-15 overflow-hidden">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110119.29170110334!2d30.47881767252762!3d30.401276251990282!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1458be390cb38497%3A0x583415d49bffadbe!2sEl%20Sadat%20City%2C%20Menofia%20Governorate!5e0!3m2!1sen!2seg!4v1715505683732!5m2!1sen!2seg" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </section>
    <div class="container">
        <div class="row">
                ...
                <section class="mb-50">
                    <div class="row mb-60">
                        <div class="col-md-4 mb-4 mb-md-0">
                            <h4 class="text-brand">Address :</h4>
                            <div>
                                Al metawaren area Sadat City, Monufia Governorate, Egypt
                            </div>
                            
                            <h4 class="mt-15 text-brand">Phone:</h4>
                            <div>
                                <?php echo e(\App\Models\Option::get('phone')); ?>

                            </div>
                            <h4 class="mt-15 text-brand">Email: </h4>
                            <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siam_ocean_app\resources\views/templates/contact.blade.php ENDPATH**/ ?>