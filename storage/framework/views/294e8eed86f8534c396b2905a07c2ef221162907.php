        ...
        <div class="product-cart-wrap mb-30 shadow-sm <?php echo e(!isset($i) ? 'wow animate__animated animate__fadeInUp' : ''); ?>" data-wow-delay="0">
            ...
            <div class="product-content-wrap">
                <div class="product-category">
                    Net Weight : <?php echo e($post->meta('data') ? json_decode($post->meta('data'), true)['weight'] : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\siam_ocean_app\resources\views/elements/product-list.blade.php ENDPATH**/ ?>