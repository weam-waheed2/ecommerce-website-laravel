            ...
            <div class="pl-25">
                ...
                <div class="carausel-3-columns-cover position-relative mt-4">
                    ...
                    <div class="carausel-3-columns" id="carausel-3-columns">
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-1.jpg')); ?>" alt="" style="height: 18vh;object-fit: cover;"/>
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-2.jpg')); ?>" alt="" style="height: 18vh;object-fit: cover;"/>
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-3.png')); ?>" alt="" style="height: 18vh;object-fit: cover;" />
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-4.jpg')); ?>" alt="" style="height: 18vh;object-fit: cover;" />
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-5.png')); ?>" alt="" style="height: 18vh;object-fit: cover;" />
                        <img src="<?php echo e(asset('assets/imgs/slider/slider-6.png')); ?>" alt="" style="height: 18vh;object-fit: cover;" />
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siam_ocean_app\resources\views/templates/about.blade.php ENDPATH**/ ?>