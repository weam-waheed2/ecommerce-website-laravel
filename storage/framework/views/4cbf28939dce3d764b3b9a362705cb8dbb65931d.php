                                ...
                                <tr class="post-index-tr">
                                    <td>
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <img src="<?php echo e($post->image()); ?>" alt="product image" class="rounded-circle" width="100" height="100">
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/siamocean.zendle.net/resources/views/admin/posts/list.blade.php ENDPATH**/ ?>