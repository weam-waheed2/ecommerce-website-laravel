            ...
            <div class="col-md-6">
                <div class="card wow animate__ animate__fadeInUp animated" data-wow-delay=".2s" style="background-color: #f3e8e8;">
                    <div class="card-body banner-text mb-3">
                        ...
                        <a class="btn btn-xs mt-2" href="<?php echo e(\App\Models\Post::find(7)->url()); ?>">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
               <div class="card wow animate__ animate__fadeInUp animated" data-wow-delay=".2s" style="background-color: #f3e8e8;">
                    <div class="card-body banner-text mb-3">
                        ...
                        <div class="title">Brand in Siam Ocean</div>
                        <a class="btn btn-xs mt-2" href="<?php echo e(\App\Models\Post::find(8)->url()); ?>">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/siamocean.zendle.net/resources/views/templates/markets.blade.php ENDPATH**/ ?>